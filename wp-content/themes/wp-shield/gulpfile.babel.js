...
// Pull Font Awesome from Node Modules to distribution
function fontawesome() {
  return gulp.src( ['node_modules/@fortawesome/fontawesome-free/webfonts/*.*', 'node_modules/@fortawesome/fontawesome-free/css/all.min.css'] )
    .pipe(gulp.dest(PATHS.dist + '/assets/webfonts/', { prefix: 3}));
}
...
gulp.task('build',
  gulp.series(clean, gulp.parallel(sass, 'webpack:build', images, fontawesome, copy)));
