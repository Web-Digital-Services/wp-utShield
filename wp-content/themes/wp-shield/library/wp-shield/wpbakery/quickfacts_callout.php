...
class uth_quickfact_callout extends WPBakeryShortCode {
    ...
    public function quickfacts_callout_html( $atts, $content ) {
        ...
        $html =
            '<div class="cell callout ' . $color_options . ' text-center" ' . $equilizer_id . '>
                <div class="grid-y factoids">
                    <div class="cell">
