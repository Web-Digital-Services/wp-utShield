...
function UTH_exito_social_media_links(){
	...
	if(!empty($UTH_social_facebook || $UTH_social_twitter || $UTH_social_instagram || $UTH_social_youtube || $UTH_social_linkedin)){
		...
		$social_media_link_html .= '<li><a href="https://www.pinterest.com/saludamerica1/"><i class="fa fa-pinterest fa-2x" aria-label="Visit the Salud America Pinterest"></i></a></li>';
		$social_media_link_html .= '<li><a href="http://www.saludtoday.com/blog/"><i class="fa-solid fa-blog fa-2x" aria-label="Visit the Salud Today Blog"></i></a></li>';
		$social_media_link_html .= '</ul>';
...
add_shortcode( 'UTH_exito_social_links', 'UTH_exito_social_media_links' );
