# WP Shield (UT Health San Antonio)
This project is based on Zurb's [Foundation for Sites 6](https://foundation.zurb.com/sites.html)and maintained by UT Health San Antonio. This theme is being customized to integrate in the [UT Health San Antonio Pattern library](https://web-digital-services.github.io/Design-System/?p=all).

## Requirements

**This project requires [Node.js](http://nodejs.org) v12.2.x to be installed on your machine.** Please be aware that you might encounter problems with the installation if you are using the most current Node version (bleeding edge) with all the latest features.
